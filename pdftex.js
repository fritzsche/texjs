...
function findWasmBinary() {
  if (Module['locateFile']) {
    return locateFile('pdftex.wasm');
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('pdftex.wasm', import.meta.url).href;
}
...
// Begin JS library code
  ...
  mknod:function() { TEXFS._throwReadOnlyError(); },
  rename:function() { TEXFS._throwReadOnlyError(); },
  unlink:function() { TEXFS._throwReadOnlyError(); },
  rmdir:function() { TEXFS._throwReadOnlyError(); },
  symlink:function() { TEXFS._throwReadOnlyError(); },
  },
  stream:{
  ...
  llseek:function(stream, offset, whence) { return TEXFS.stream_ops.llseek(stream, offset, whence); },
  write:function() { TEXFS._throwReadOnlyError(); },
  mmap:function() { TEXFS._throwReadOnlyError(); },
  ...
  objectCache__deps:["$FS"],
  debug__deps:["$FS"],
  _throwReadOnlyError__deps:["$FS"],
  fetchObject__deps:["$FS"],
  mount__deps:["$FS"],
  createNode__deps:["$FS"],
  ops_table__deps:["$FS"],
  loadTree__deps:["$FS"],
